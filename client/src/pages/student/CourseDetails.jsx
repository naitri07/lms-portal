...
const CourseDetails = () => {
  ...
  const ratingsCount = courseData.courseRatings?.length || 0
  const studentsCount = courseData.enrolledStudents?.length || 0
    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(6, 182, 212, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)'
          }}
        ></div>

        {/* Left Column */}
        <div className='flex-1 z-10 text-gray-500'>
          <h1 className='md:text-4xl text-2xl font-semibold text-gray-800'>
            {courseData.courseTitle}
          </h1>
          
          <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{ __html: courseData.courseDescription?.slice(0, 200) || 'No description available' }}></p>

          {/* Reviews and Ratings */}
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm flex-wrap'>
            ...
            <p className='text-gray-500'>
              {studentsCount} {studentsCount !== 1 ? 'students' : 'student'}
            </p>
          </div>

          <p className='text-sm mt-2'>
            Course by <span className='text-blue-600 underline font-medium'>{courseData.educator.name}</span>
          </p>
        ...
        {/* Right Column */}
        <div className='md:w-96 w-full shrink-0 z-10 bg-white rounded-lg shadow-lg overflow-hidden'>
          ...
          <div className='p-5'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <p className='text-red-500 text-sm'><span className='font-medium'>5 Days left at this price!</span></p>
            </div>
            ...
            {/* Enroll Button */}
            <button onClick={enrolledCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium hover:bg-blue-700 transition'>
